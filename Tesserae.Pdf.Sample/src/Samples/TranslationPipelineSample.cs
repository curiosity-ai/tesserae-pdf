            ...
            _content = SectionStack().Secondary()
               ...
               .FlatSection(VStack().Children(
                    Card(VStack().WS().Children(
                        ...
                        TextBlock("2. The id becomes an English literal. PdfL10nStrings maps all 50 ids pdf.js can ask for onto \"Page {0}\".t() and its 49 siblings - written out as literals rather than looked up, because TNTC extracts translatable strings by scanning source for .t() applied to one - which is how the package translates them for you, into the tables it ships.").MT(8),
